...
const socialLinks = [
  { icon: Globe, label: 'Website', href: data.facebookLink },
  { icon: Link2, label: 'Instagram', href: data.instaLink },
  { icon: Share2, label: 'Twitter', href: data.twitterLink },
  { icon: Globe, label: 'GitHub', href: data.githubLink },
  { icon: Link2, label: 'Dribbble', href: data.dribbbleLink },
];
